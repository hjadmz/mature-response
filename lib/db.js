...
/**
 * Permanently delete everything. Checkpointing the WAL and vacuuming
 * afterwards means the bytes are actually gone from disk, not just
 * unreferenced — "erase" should mean erase.
 */
